...
class FilmActorDetailAdapter(private val onClickFilm: (FilmItem) -> Unit, private val actorFilms: List<FilmItem>) :
    RecyclerView.Adapter<FilmActorDetailAdapter.FilmViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): FilmViewHolder {
        val binding = ItemRecyckerFilmPagedAdapterTextRightBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    class FilmViewHolder(val binding: ItemRecyckerFilmPagedAdapterTextRightBinding) : RecyclerView.ViewHolder(binding.root)
}